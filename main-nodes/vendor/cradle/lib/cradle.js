    ...
    return {
       ...
       _merge: function (id, doc, callback) {
        ...
        put: function (id, doc, callback) {
            ...
            this.query('PUT', querystring.escape(id), null, doc, function (e, res) {
        ...
        head: function (id, callback) {
            this.query('HEAD', querystring.escape(id), null, callback);
        },
        ...
        remove: function (id, rev) {
            ...
            this.query('DELETE', querystring.escape(id), {rev: rev}, function (err, res) {
        ...
        some: function (options, keys, callback) {
            if (arguments.length === 1) { callback = options, options = {} }
            this.query('POST', '/_all_docs', options, keys, callback);
        },
        ...
        // Dispatch a spatial query (for GeoCouch only)
        spatial: function(path, bbox, options) {
            var args = new(Args)(arguments);
            path = path.split('/');
        ...
        update: function(path, id, options, data) {
            ...
            if (id) {
              ...
              this.query('POST', ['_design', path[0], '_update', path[1]].map(querystring.escape).join('/'), options, data, args.callback);
            }
        },
