module.exports = function(h) {
	...
	return {
		...
		unlock : function(req, res, next) {
			//TODO: check if document & attachment exist
			//TODO if token is correct
			//TODO: update attachment document and set enabled
			//TODO: if first attachment, then set document enabled
			res.send(501);
			return next();
		},
